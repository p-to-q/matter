...
/**
 * The only error type that may cross the inquiry boundary. Provider messages,
 * stack traces and the question itself stay on the server; the browser receives
 * a stable code, a human sentence, and whether retrying could help.
 */
