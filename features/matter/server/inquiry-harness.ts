...
export function compileInquiryPrompt(request: InquiryRequest): string {
  ...
  return composePrompt("matter-inquiry", INQUIRY_PROMPT_VERSION, {
    ...
    never: [
      ...
      "propose an edit, rewrite a passage, or tell the person what to do next unless they asked for that;",
    ...
    answer: [
      "Answer briefly. Prefer plain prose; use structure only when the person's question needs it.",
    ],
    material: [
