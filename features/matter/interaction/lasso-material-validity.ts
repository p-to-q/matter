...
/** A material revision only revokes lasso authority when its addressed text changed. */
...
/** Plans resource release and semantic retention before the hook mutates either. */
