...
2. **Intelligence is a property of material.** There is no assistant surface.
   One turn becomes one local, perceivable, pointer-undoable change.
...
6. **Quietness is functional.** Controls appear where material needs a handle.
   Status, AI, and infrastructure do not become permanent chrome.
